...
колонки имеют position - порядковый номер для отображения слева направо
position = max + 1
"""
...
"""
Создает колонку на доске;
board_id передается через query-параметр
"""
...
"""
Удаляет колонку со всеми карточками;
каскадное удаление настроено в модели
"""
...
"""
удаление всех колонок доски;
используется при очистке доски
"""
